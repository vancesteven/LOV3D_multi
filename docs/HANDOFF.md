...
| TASK-006 | **M5:** `assemble_bc_ocean_coupled` (24N×24N) | CODEX | IN-PROGRESS | `docs/tasks/TASK-006-codex-bc-ocean-coupled.md` |
...
| TASK-008 | **M5:** MATLAB reference for ocean+lateral validation — Weber Moon case (`data/tests/moon/*.mat` exists, unused) + optionally regenerate/extend via `tests/Test_Moon_MultiLayered_Lateral_Variations.mlx` and Europa case. Machine B (MATLAB) | B | IN-PROGRESS — parse existing `.mat`, build skipped skeleton parallel w/ 006/007 | — |
