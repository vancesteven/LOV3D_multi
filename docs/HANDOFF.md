...
| TASK-013 | **M6:** Mars SH data loaders (GMM-3 gravity SHADR + MarsTopo719 shape). Data fetched + pinned in `data/mars/` (`SOURCES.md`; PDS node was down — used the live sdp mirror + Zenodo) | CODEX | IN-PROGRESS — runs concurrently with 012 (disjoint allowlists) | `docs/tasks/TASK-013-codex-mars-sh-loaders.md` |
