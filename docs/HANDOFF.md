...
| TASK-019 | **M7:** properly-resolved Moon posterior under the shipped bounds (n_active>=64, n_effective>=128; the quoted 363.7±33.2 km reference run predates the density floor). **Machine B** — compute-heavy, token-light | B | **IN-PROGRESS (B, 2026-08-05)** | `pylov3d/moon_mc.py` |
...
_(Older M4 / M5 / TASK-001…010 entries pruned — see git history.)_
