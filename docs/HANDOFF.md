...
| TASK-012 | **M6:** lateral-rheology mapping design — how gravity/topography/crustal-thickness fields become `mu_variable` amplitudes (dichotomy, Tharsis); science-reviewed; then coupled integration | A | QUEUED — next on A | — |
